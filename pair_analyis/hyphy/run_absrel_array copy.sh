...
TREE_FILE="$PATH_TO_PAIRS/genome_data/ncbi_dataset/data/pruned_10_species_analysis_inno.nwk"
RESULT_DIR="$PATH_TO_PAIRS/genome_data/ncbi_dataset/data/absrel_results_correct_inno_10"
